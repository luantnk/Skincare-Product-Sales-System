...
IF NOT EXISTS (
    ...
    WHERE [MigrationId] = N'20250610013533_AddTransactionTable'
)
BEGIN
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20250624025828_AddPurchasePriceToProduct'
)
BEGIN
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20250701132253_AddChatHistoryTable'
)
BEGIN
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20250701134059_CreateChatHistoryTable'
)
BEGIN
    CREATE TABLE [ChatHistories] (
        [Id] uniqueidentifier NOT NULL,
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20250701134059_CreateChatHistoryTable', N'9.0.2');
END;
